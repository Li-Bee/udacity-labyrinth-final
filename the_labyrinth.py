...
# player list - to select character - same character entire game therefore global variable
player_list = ["elf", "fairy",
               "human", "witch", "wizard"]
player = ""  # empty is assigned value in choose_character function

# enemy list - random module to select - same enemy entire game therefore global variable
...
riddle_three = ("I can be thrown but I can be caught.\n"
                "Ways to lose me are always being sought.\n\n")  # cold / a cold
...
def choose_character(inventory):
    ...
    # Change the value of the global variable into some function. You must use the global keyword.
    global player
...
def strange_man(inventory):
    ...
    if help_man == "1":
        ...
        if riddle_entry in riddle_answers:  # match answer in list of answers
            ...
            commentary(
                "With a flick of his hand, you find a necklace around your neck.")
            commentary("The chain is platinum and the oval crystal sits "
                       "cooly against your skin.")
            commentary("When you touch the crystal it hums and suddenly glows red "
            ...
            commentary("'This crystal will change color as your emotions "
                       "change and will provide you with aid when you "
                       "are in most need.'")
            commentary("'Look after her heart fragment and guard it with your own,"
            ...
            commentary(
                "You hold you hand out and an amethyst crystal ball appears.\n")
            commentary(
                "'Take this crystal, it will guide you in the darkest night'\n")
...
def maze_lions(inventory):
    ...
    commentary(
        "You notice that the path is blocked by two great ancient oak doors.")
    commentary("In front of these doors are two proud 8ft stone lions.")
    commentary("These lions seems to be guarding the doors?\n")

    commentary("Suddenly the stone eyes of the lions both open at the same time.")
    ...
    if "necklace" in inventory:
        ...
        if left_door == "correct door" and door == "1" or right_door == "correct door" and door == "2":
            commentary(f"You point to the {necklace_door} and it opens.")
            commentary(f"The maze continues in front of you. "
                       f"You made the right choice\n")
            maze_fight(inventory)

        elif left_door == "wrong door" and door == "1" or right_door == "wrong door" and door == "2":
...
# Below code is based/adapted from: https://github.com/darylkevin/Python-Adventure-Game/blob/master/adventure_game.py
